...
interface DeleteCallToActionModalProps {
    open: boolean;
    onClose: () => void;
...
export default function DeleteCallToActionModal({
    open,
    onClose,
    onConfirm,
    loading = false,
}: DeleteCallToActionModalProps) {
    if (!open) return null;
            ...
            <div className="w-full max-w-md rounded-3xl bg-white p-8 shadow-2xl">
                ...
                <div className="text-center">
                    ...
                    <p className="mt-3 leading-6 text-slate-500">
                        This will permanently remove the current Call To
                        Action from the database. This action cannot be undone.
                    </p>
